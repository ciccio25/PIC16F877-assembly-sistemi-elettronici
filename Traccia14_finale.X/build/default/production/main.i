...
UART_TX_BUSY EQU 0
EUSART_TRANSMIT_BUFFER_FULL EQU 0 ;((PIR1) and 07Fh), 4 IN PIR1 DA CONTROLLARE BUSY
...
start:
 ...
 ;Bit ((INTCON) and 07Fh), 6 of the INTCON register must be set to enable any perpheral interrupt
 ;Quindi andiamo sul registro INTCON

 ;Register 2-3: INTCON: INTERRUPT CONTROL REGISTER
 ;I bit sono settati di default a 0, tranne ((INTCON) and 07Fh), 0 (nel nostro caso non e' nel nostro studio) 
 ;Indichiamo di seguito i bit che interessano nel nostro progetto

 ;bit 4 ((PIE1) and 07Fh), 4: EUSART Transmit Interrupt Enable bit --> Perche' i caratteri li invieremo in EUSART 
 ;1 = Enables the EUSART Transmit Interrupt
 ;0 = Disables the EUSART Transmit Interrupt

 ;bit 6 ((INTCON) and 07Fh), 6: Peripheral Interrupt Enable bit --> Da 2.2.2.4 PIE1 Register Note: Bit ((INTCON) and 07Fh), 6 of the INTCON register must be set to enable any peripheral interrupt
 ;1 = Enables all unmasked peripheral interrupts
 ;0 = Disables all peripheral interrupts

 ;bit 7 ((INTCON) and 07Fh), 7: Global Interrupt Enable bit --> Senza questo bit a 1 non possiamo bloccare il codice quando avvengono gli interrupt
...
init_hw:
 ...
 ;bit 0 ((OSCCON) and 07Fh), 0: System Clock Select bit
 ...
 ;Note: The TMR1H:TMR1L register pair and the ((PIR1) and 07Fh), 0 should be cleared before enabling interrupts
 ...
 ;bit 0 ((T1CON) and 07Fh), 0: Timer1 ON bit
 ;1 = Enables Timer1
 ;0 = Stops Timer1

 ;bit 1 ((T1CON) and 07Fh), 1: Timer1 Clock Source Select bit
 ;0 = Internal clock (Fosc/4)

 ;bit 2 ((T1CON) and 07Fh), 2
 ;IF ((T1CON) and 07Fh), 1 = 0
 ;--> This bit is ignored. Timer1 uses the internal clock
 ;IF ((T1CON) and 07Fh), 1 = 1
 ;1--> Do not synchronize external clock input


 ;bit 3 ((T1CON) and 07Fh), 3: LP Oscillator Enable Control bit
 ...
 ;bit 6 ((T1CON) and 07Fh), 6: Timer1 Gate Enable bit
 ;if TMR1 = 0
 ;--> This bit is ignored
 ;if TMR1 = 1
 ...
 ;Setup dell'EUSART 
 ;Baud rate = 19200 (((TXSTA) and 07Fh), 2 = 1, ((BAUDCTL) and 07Fh), 3 = 0)
 ;((TXSTA) and 07Fh), 5 = 1
 ;((RCSTA) and 07Fh), 7 = 1
 ;((RCSTA) and 07Fh), 4 = 1
 ...
 ; i pin ((PORTB) and 07Fh), 0 ..((PORTB) and 07Fh), 3
 ...
 clrf ANSELH ; AN8..AN13 disattivati
    ...
    ; quindi uso solo il pin P1A che nella piedinatura del mio pin corrisponde proprio al pin ((PORTC) and 07Fh), 2 (ingresso del buzzer)
...
test_timer1:
   ; testa evento overflow timer1 (((PIR1) and 07Fh), 0 + ((PIE1) and 07Fh), 0)
   banksel PIR1
